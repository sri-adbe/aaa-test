...
/**
 * Transformer: AAA (ace.aaa.com) Dynamic Media / Scene7 images.
 * Source contains Scene7 IS/Image URLs (e.g.
 * https://assets.ace.aaa.com/is/image/aceaaa/...). Rewrites DM <img> tags
 * into anchors so the DM URL round-trips through markdown; the companion
 * auto-block in scripts/scripts.js rebuilds responsive <picture> at render
 * time. Runs in afterTransform only — block parsers run between the hooks
 * and extract <img> into block cells, so rewriting earlier would empty them.
 *
